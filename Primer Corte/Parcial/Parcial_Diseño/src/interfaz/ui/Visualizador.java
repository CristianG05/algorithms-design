...
public final class Visualizador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(botonGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 370, 120, 120));
        ...
        panelBarra.add(barraProgreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 610, -1));
        ...
        botonImagen.setFont(new java.awt.Font("Lucida Bright", 2, 36)); // NOI18N
        ...
        getContentPane().add(botonImagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 610, 360));
        ...
        getContentPane().add(botonDescifrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 370, 120, 120));
        ...
        getContentPane().add(botonCargar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 400, 120, 90));
        ...
        getContentPane().add(botonCifrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, 120, 120));

        areaTexto.setColumns(20);
        areaTexto.setRows(5);
        panelScrol.setViewportView(areaTexto);

        getContentPane().add(panelScrol, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, 610, 120));
        ...
        getContentPane().add(labelInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, 610, 160));
